...
mate_pkgs_ol8="NetworkManager-adsl NetworkManager-bluetooth NetworkManager-libreswan-gnome NetworkManager-openvpn-gnome 
    ...
    abrt-java-connector adwaita-gtk2-theme alsa-plugins-pulseaudio atril atril-caja atril-thumbnailer caja caja-actions 
    caja-image-converter caja-open-terminal caja-sendto caja-wallpaper caja-xattr-tags dconf-editor engrampa eom firewall-config 
    gnome-disk-utility gnome-epub-thumbnailer gstreamer1-plugins-ugly-free gtk2-engines gucharmap gvfs-afc gvfs-afp gvfs-archive 
    gvfs-fuse gvfs-gphoto2 gvfs-mtp gvfs-smb initial-setup-gui libmatekbd libmatemixer libmateweather libsecret lm_sensors marco mate-applets 
    mate-backgrounds mate-calc mate-control-center mate-desktop mate-dictionary mate-disk-usage-analyzer mate-icon-theme mate-media 
...
function OS_Init() {
    ...
    case "${OS_TYPE} ${OS_VERSION}"  in
        "CentOS Linux 7")          
            sudo yum install epel-release kernel-devel -y   
            ;;
        "Rocky Linux 8")
        ...
        "Oracle Linux Server 8")
            printf "\n  o Enable EPEL Oracle Linux 8 repo\n"
            sudo yum install https://dl.fedoraproject.org/pub/epel/epel-release-latest-8.noarch.rpm -y
            sudo yum copr enable stenstorp/MATE -y
            sudo yum copr enable stenstorp/lightdm -y
            ;;
        "Rocky Linux 9")
        ...
        "Oracle Linux Server 9")
            printf "\n  o Enable EPEL Oracle Linux 9 repo\n"
            sudo yum install oracle-epel-release-el9 -y 
